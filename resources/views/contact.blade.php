            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('contact') }}" class="text-indigo-600 px-3 py-2 rounded-md text-sm font-medium">Contact</a>
                        @auth
                        ...
                        <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="subject" id="subject" required
                                       class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('subject') border-red-300 @enderror"
                                       value="{{ old('subject') }}">
                                @error('subject')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <textarea name="message" id="message" rows="4" required
                                          class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('message') border-red-300 @enderror">{{ old('message') }}</textarea>
                                @error('message')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="space-y-8">
                        <div>
                            ...
                            <p class="text-gray-600 mb-6">
                                Have a question about our services? Need help with your account?
                        ...
                        <div class="space-y-6">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">support@minibank.com</p>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">1-800-MINIBANK</p>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">123 Financial District<br>New York, NY 10004</p>
                                    <p class="text-sm text-gray-500">Visit our headquarters</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-600">Monday - Friday: 8:00 AM - 8:00 PM<br>Saturday: 9:00 AM - 5:00 PM<br>Sunday: Closed</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="py-16 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    <a href="{{ route('faq') }}" class="group bg-gray-50 rounded-lg p-6 hover:bg-indigo-50 transition-colors">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="flex items-center justify-center h-8 w-8 rounded-md bg-indigo-500 text-white group-hover:bg-indigo-600">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900 group-hover:text-indigo-600">FAQ</h3>
                                <p class="text-gray-500">Common questions and answers</p>
                            </div>
                        </div>
                    </a>

                    <a href="{{ route('about') }}" class="group bg-gray-50 rounded-lg p-6 hover:bg-indigo-50 transition-colors">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="flex items-center justify-center h-8 w-8 rounded-md bg-indigo-500 text-white group-hover:bg-indigo-600">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900 group-hover:text-indigo-600">About Us</h3>
                                <p class="text-gray-500">Learn more about MiniBank</p>
                            </div>
                        </div>
                    </a>

                    @auth
                        <a href="{{ route('dashboard') }}" class="group bg-gray-50 rounded-lg p-6 hover:bg-indigo-50 transition-colors">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <div class="flex items-center justify-center h-8 w-8 rounded-md bg-indigo-500 text-white group-hover:bg-indigo-600">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-medium text-gray-900 group-hover:text-indigo-600">Dashboard</h3>
                                    <p class="text-gray-500">Access your account</p>
                                </div>
                            </div>
                        </a>
                    @else
                        <a href="{{ route('register') }}" class="group bg-gray-50 rounded-lg p-6 hover:bg-indigo-50 transition-colors">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                                    <div class="flex items-center justify-center h-8 w-8 rounded-md bg-indigo-500 text-white group-hover:bg-indigo-600">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-medium text-gray-900 group-hover:text-indigo-600">Sign Up</h3>
